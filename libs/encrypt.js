...
function changeParamPassword(vals){
	var obj = vals.split("&").reduce(function(prev, curr, i, arr) {
	    var p = curr.split("=");
	...
	var key = 'abcd1234';
	//alert(obj.my_account_password);
	obj.my_account_password = encryptByDES(obj.my_account_password, key);
	...
	//paramString = encodeURIComponent(paramString.slice(0,-1));
	//alert(vals);
	//alert(paramString);
	return paramString;
}